...
_setupObjects =
{
	...
	_missionHintText = format ["A treasure trove containing <t color='%1'>$50,000</t> and weapons is being recovered.<br/>If you want to capture it, you will need diving gear and an underwater weapon.", moneyMissionColor];
};
